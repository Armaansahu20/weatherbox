...
#     def __repr__(self):
#         return f"T: {self.temp}, H: {self.humidity}, WS: {self.windspeed}, P: {self.pressure}"
...
def dowork(request):
    ...
    # API_KEY = "VE6X4JKF9VAY4SMTN54G852ZX" #mine
    API_KEY = "P8HLX89HW3R6FX6A3L5FPV5RX" #armaan sir's
    ...
    # print(predlist, predicted_labels, current_data, current_label, f"{dms_latitude}, {dms_longitude}", locationstr, timelabels)
...
# @app.route('/')
# def index():
#     # You can now access g.request_start_time within your view function
#     yr = g.request_start_time.tm_year
#     mon = g.request_start_time.tm_mon
#     day = g.request_start_time.tm_mday
#     END_DATE = date(yr,mon,day)
...
#     # ... your view logic ...
#     return f"Request received at: {startdate}-{enddate}"
